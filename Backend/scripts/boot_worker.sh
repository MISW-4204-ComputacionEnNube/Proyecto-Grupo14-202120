...
# ----------------------------------------------------------------------------
​
# Definición del script para descargar el proyecto e instalar los servicios en el Worker.
​
# ----------------------------------------------------------------------------
​
# creditos
...
# Crea una tarea programada cada minuto para la ejecucion de la conversion
echo "*/1 * * * * /usr/bin/wget localhost:8080/api/convert" | crontab -
